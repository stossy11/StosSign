...
final public class AES256CBC {
    ...
    public class func decryptString(_ str: String, password: String) -> String? {
        if str.count > 16 && password.count == 32 {
            ...
            do {
                let decryptedString = try aesDecrypt(encryptedString, key: password, iv: String(iv))
...
extension UInt32: BitshiftOperationsType, ByteConvertible {
    ...
    init(_ value: UInt8) {
        self = UInt32(truncatingIfNeeded: UInt64(value))
    }
...
fileprivate extension Collection where Self.Iterator.Element == UInt8, Self.Index == Int {
    func toInteger<T: BinaryInteger & ByteConvertible & BitshiftOperationsType>() -> T {
        if self.isEmpty {
            return 0
        }
